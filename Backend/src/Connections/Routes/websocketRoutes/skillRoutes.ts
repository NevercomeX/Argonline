...
router.get("/characterskill/:characterId/skills", async (req: any, res: any) => {
...
router.get("/characterskill/jobclassid/:jobclass", async (req: any, res: any) => {
...
router.post("/characterskill/:characterId/skills/:skillId/level-up", async (req: any, res: any) => {
  const characterId = parseInt(req.params.characterId);
...
router.post("/characterskill/:characterId/skills/reset", async (req: any, res: any) => {
  const characterId = parseInt(req.params.characterId);
  try {
...
router.get("/characterskill/:characterId/skills/learned", async (req: any, res: any) => {
  const characterId = parseInt(req.params.characterId);
  try {
...
router.post("/characterskill/:characterId/skills/:skillId/learn", async (req: any, res: any) => {
  const characterId = parseInt(req.params.characterId);
  const skillId = parseInt(req.params.skillId);
  try {
