...
router.get("/", async (req, res) => {
  const page = parseInt(req.query.page as string) || 1; // Página actual, por defecto es 1
  const pageSize = parseInt(req.query.pageSize as string) || 9; // Tamaño de página, por defecto es 10
