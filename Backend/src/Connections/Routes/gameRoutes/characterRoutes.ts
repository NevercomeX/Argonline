...
router.get("/", async (req, res) => {
  try {
    const page = parseInt(req.query.page as string) || 1; // Obtener el número de página desde query params
    const limit = parseInt(req.query.limit as string) || 9; // Limitar personajes por página
