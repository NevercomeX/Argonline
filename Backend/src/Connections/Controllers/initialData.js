import { getCharacterById, getInventoryById, getCharacterInventoryItems, getStorageItemById, getEquipmentSlotsByCharacterId  } from "./index.js";

/**
 * Obtiene todos los datos iniciales para cargar el juego.
 */
export async function getInitialData(characterId) {
  try {
