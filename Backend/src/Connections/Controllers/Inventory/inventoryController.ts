 ...
 */
export async function getInventory(characterId: any) {
  try {
 ...
 */
export async function getInventoryById(id: any) {
  try {
 ...
 * @returns {Promise<Array>}
 */
export async function getInventoryByItemId(itemId: any) {
  try {
 ...
 * @returns {Promise<Object>}
 */
export async function getCharacterInventoryItems(characterId: any) {
  try {
 ...
 */
export async function addItemToInventory(characterId: any, itemId: any, quantity: any) {
  try {
 ...
 * @returns {Promise<void>}
 */
export async function removeItemFromInventory(characterId: any, itemId: any, quantity: any) {
  try {
    const parsedQuantity = parseInt(quantity);
    const existingItem = await prisma.inventoryItem.findFirst({
      where: {
