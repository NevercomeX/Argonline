...
import { Link } from "react-router-dom"; // Asumiendo que usas React Router para navegación

interface MainLayoutProps {
  children: React.ReactNode; // Contenido dinámico que se renderizará dentro del layout
}
      ...
      <header className="bg-black text-white p-4 flex justify-between items-center">
        ...
        <nav>
          <ul className="flex space-x-6">
            ...
            <li><Link to="/mobs" className="hover:text-gray-300">Monsters</Link></li>
            <li><Link to="/items" className="hover:text-gray-300">Items</Link></li>
      ...
      <div className="flex flex-1">
        ...
        <aside className="w-64 bg-gray-100 p-4 hidden md:block">
          ...
          <ul className="space-y-2">
            <li><Link to="/monsters" className="block hover:bg-gray-200 p-2 rounded">Monsters</Link></li>
