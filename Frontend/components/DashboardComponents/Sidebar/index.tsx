...
import SidebarItem from "@/components/DashboardComponents/Sidebar/SidebarItem";
...
const menuGroups = [
  {
    ...
    menuItems: [
      ...
      },
      {
        ...
        route: "#",
        children: [
          { label: "All Character", route: "/characters" },
          {
            label: "Create Character",
            route: "/characters/createCharacter/step1",
          },
...

      {
        ...
        label: "Inventory",
        route: "#",
        children: [{ label: "Inventory", route: "/inventory" }],
      },
      {
        icon: (
          <svg
        ...
        label: "Shop",
        route: "#",
        children: [{ label: "Shop", route: "/shop" }],
      },
      {
        icon: (
          <svg
        ...
        route: "#",
        children: [
          { label: "All Monsters", route: "/mobs" },
          { label: "Bosses", route: "/bosses" },
          { label: "Mini-Bosses", route: "/mini-bosses" },
        ],
      },
      {
        icon: (
      ...
      },
      {
        ...
        children: [
          ...
          { label: "Game Settings", route: "/settings/game" },
        ],
      },
    ],
  },
